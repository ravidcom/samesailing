    ...
    <div ref={rootRef} className="relative shrink-0 border-b border-border bg-[#f3fbfb] px-3.5 py-2.5">
      ...
      {open ? (
        <div
          ...
          className="absolute inset-x-3.5 top-full z-[160] mt-1.5 max-h-[60vh] overflow-y-auto rounded-2xl border border-[#d8ebec] bg-white py-1.5 shadow-[0_20px_40px_-18px_rgba(14,80,88,.5)] outline-none"
        >
