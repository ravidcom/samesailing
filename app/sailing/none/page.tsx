...
export default async function NoSailingsPage({
  searchParams,
}: PageProps<"/sailing/none">) {
      ...
      <main className="flex min-h-screen items-start justify-center px-4 pt-[100px] pb-16 text-center">
        <div className="w-full max-w-[440px]">
          ...
          <h1 className="mb-3 font-display text-2xl font-bold text-charcoal">
            No sailings listed yet
          </h1>
          <p className="mb-8 text-sm leading-relaxed text-muted">
            {ship ? <>We don&apos;t have any upcoming dates for <strong>{ship}</strong> yet.</> : "We don't have any upcoming dates for that ship yet."}{" "}
            Check back soon, or search another sailing.
          </p>
          <Link
            href="/"
